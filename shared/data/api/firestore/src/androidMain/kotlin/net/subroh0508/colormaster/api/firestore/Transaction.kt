...
actual class Transaction(val android: FirestoreTransaction) {
    ...
    actual suspend fun get(documentRef: DocumentReference) = DocumentSnapshot(android.get(documentRef.android))
}
