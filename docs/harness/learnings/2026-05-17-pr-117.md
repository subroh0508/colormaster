...
| 提案 | 保留理由 |
|---|---|
| `[template]` `docs/harness/learnings/template.md` 新規追加 | `pr-retrospective` Skill 本格化 (A3) と同時に追加する方が retrospective-format.md との整合性が取れる。A3 で再評価 → **本 PR (PR-1、`harness/meta-improvements-2026-W20`) で消化 ✅** |

### 2026-05-17 本 PR (PR-1、`harness/meta-improvements-2026-W20`) で消化 (採用)

| 提案 | 本 PR での消化内容 |
|---|---|
| `[template]` `docs/harness/learnings/template.md` 新規追加 | `docs/harness/learnings/template.md` を新規作成、`.claude/rules/retrospective-format.md` 準拠の暫定テンプレ (pr-retrospective Skill 本格化前)。A3 で Skill 自動生成に切替予定 |
