...
fun <T : ComponentActivity> Context.intentTo(kClass: KClass<T>) =
    Intent().also {
...
fun Context.intentToPreview(type: ScreenType, ids: List<String>) =
    intentTo(PreviewActivity::class).also {
